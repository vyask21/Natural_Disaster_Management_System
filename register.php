	...
	<div class="container">
		...
		<div class="row">
            <div class="col-sm-8 col-sm-offset-2 text">
                <h1><strong>Registration</strong>desk</h1>               
            </div>
        </div>
                ...
                <div class="form-bottom">
					<form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="signupform">	
						<div class="form-group">								
							<input type="text" name="name" placeholder="Enter Full Name" autocomplete="off" required value="<?php if($error) echo $name; ?>" class="form-control" autofocus/>
							<span class="text-danger"><?php if (isset($uname_error)) echo $uname_error; ?></span>
						</div>					
						<div class="form-group">								
							<br><input type="text" name="email" placeholder="Email" autocomplete="off" required value="<?php if($error) echo $email; ?>" class="form-control" onkeyup="showHint(this.value)"/>
                            <span id="txtHint"></span>
							<span class="text-danger"><?php if (isset($email_error)) echo $email_error; ?></span>
						</div>
						<div class="form-group">								
							<br><input type="password" name="password" placeholder="Password" required class="form-control" />
							<span class="text-danger"><?php if (isset($password_error)) echo $password_error; ?></span>
						</div>						
						<div class="form-group">
							<br><button type="submit" name="signup" value="Sign Up" class="btn btn-primary" />Sign up</button>
						</div>						
					</form>
				</div>
                <p>Already a member? <a href="login.php">Login</a> here!<br>Administrator <a href="alogin.php">login</a></p>				
			</div>
		</div>			
	</div>
     <section>
