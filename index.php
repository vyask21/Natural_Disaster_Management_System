...
<html>
    <head>
        ...
        <link rel="stylesheet" href="assets1/css/c.css">          
        ...
        <style type="text/css">        
          ...
          .fade-carousel .slides .slide-1 {
            background-image: url('assets1/img/3.jpg'); 
          }
          .fade-carousel .slides .slide-2 {
            background-image: url('assets1/img/1.jpg');
          }
          .fade-carousel .slides .slide-3 {
            background-image: url('assets1/img/2.jpg');
          }
    ...
    <body class="LongFormPage">
     ...
     <div id="ad">
        ...
        <br><a href="https://www.indianredcross.org/ircs/index.php" target="_blank"><img src="assets1/img/ad.png" alt="Red Cross" width="400" height="90" border="0"></a>
            </div>
